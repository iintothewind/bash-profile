...
nnoremap <silent> <Leader>f <Plug>(easymotion-overwin-f)
...
"  CTRL-P (retained for reference; fzf is primary picker)
...
"nnoremap <silent> <F11> :<C-U>LeaderfFile<CR>
"nnoremap <silent> <F12> :LeaderfMru<CR>
...
" YouCompleteMe
" Removed for performance and simplicity. Relying on vim-auto-popmenu.
